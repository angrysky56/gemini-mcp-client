...
class ConfigManager:
    ...
    def export_claude_desktop_config(self, output_file: Optional[str] = None) -> Dict[str, Any]:
        """
    ...
    def import_claude_desktop_config(self, config_file: Union[str, Path]) -> None:
        """
        ...
        if imported_count > 0:
            ...
            self.logger.warning("No servers were imported")
